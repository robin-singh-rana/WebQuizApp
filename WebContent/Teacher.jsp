...
<html>
	...
	<marquee behavior="scroll" scrollamount="20">
		<h1><b><i style="color:white; font-family: Georgia; font-weight: bold; font-size: 1em; text-shadow: 0px 2px 4px cyan;">WELCOME TO TEACHER SECTION</i></b></h1>
	</marquee>
	<div class="form-wrap">
		<div class="tabs">
		...
		<div class="tabs-content">
			<div id="signup-tab-content" class="active">
				<form class="signup-form" action="SaveDataTeacher.jsp" method="post">
			...
			<div id="login-tab-content">
				<form class="login-form" action="VerifyTeacher.jsp" method="post">
